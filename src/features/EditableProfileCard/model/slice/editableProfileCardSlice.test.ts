...
import { editableProfileSliceActions, editableProfileSliceReducer } from './editableProfileCardSlice';
...
describe('ProfileSlice', () => {
    ...
    test('should handle fetch profile data service pending', () => {
        ...
        expect(editableProfileSliceReducer(
            state as EditableProfileCardSchema,
            fetchProfileData.pending as any,
        ))
            .toEqual({
                isLoading: true,
            });
