[![Netlify Status](https://api.netlify.com/api/v1/badges/e5ca207b-15ae-41f3-9d60-8666f8c5c26f/deploy-status)](https://app.netlify.com/sites/gleeful-sundae-83e498/deploys)
# React-production
...
To control FSD rules custom _eslint-plugin-fish-triangle-eslint-plugin_ is installed.
It contains 3 rules:
...
Server requests are mocked with _storybook-addon-mock_.
